    ...
    public void upload() {
        ...
        try {
            UploadObjectArgs uploadObjectArgs = UploadObjectArgs.builder()
                    .bucket("testbucket")
                    .object("test/第3章媒资管理模块 (3).docx")//同一个桶内对象名不能重复
                    .filename("G:\\学习\\技术学习\\JAVA\\项目\\1、黑马程序员Java项目《学成在线》企业级开发实战\\学成在线项目-资料\\day04 媒资管理 Nacos Gateway MinIO\\资料/第3章媒资管理模块 (3).docx")
                    .build();
            //上传
